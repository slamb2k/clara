...
{injected_prompt}
"""
    follow_up_questions_prompt_content = """Generate three very brief follow-up questions that the user would likely ask next about coding and the Girl Geek Academy. 
Use double angle brackets to reference the questions, e.g. <<Who founded the Girl Geek Academy?>>.
Try not to repeat questions that have already been asked.
Only generate questions and do not generate any text before or after the questions, such as 'Next Questions'"""

    query_prompt_template = """Below is a history of the conversation so far, and a new question asked by the user that needs to be answered by searching in a knowledge base about coding and the Girl Geek Academy.
...
"""
    query_prompt_few_shots = [
        {'role' : USER, 'content' : 'What regular events do the Girl Geek Academy run?' },
        {'role' : ASSISTANT, 'content' : 'List regular events such as Microsoft Mondays' },
        {'role' : USER, 'content' : 'Who originally started Girl Geek Academy?' },
        {'role' : ASSISTANT, 'content' : 'List the all-female founding members: Amanda, Lisy, Tammy, Sarah and April' }
    ]
